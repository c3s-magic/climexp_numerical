...
class ClimExp:
    ...
    def correlatefield(self, observation="cru_ts3.22.1901.2013.pre.dat.nc",
                       model="nino3.nc",
                       frequency="mon",
                       timeselection="1:12",
                       averaging="ave",
                       ...
                       callback=_callback):
        """
        Calls climate explorer's correlatefield,
        callback is called during execution
        l"""
        correlateFieldExecutable = os.path.join(self.climexpHome,
                                                "correlatefield")
        args = [correlateFieldExecutable,
                observation,
                model,
                frequency,
                timeselection,
